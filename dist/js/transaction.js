...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__db1__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_js_datepicker__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_js_datepicker___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_js_datepicker__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__directive__ = __webpack_require__(6);
...
Vue.directive('dropdown', __WEBPACK_IMPORTED_MODULE_4__directive__["a" /* dropdown */]);
Vue.directive('next-show', __WEBPACK_IMPORTED_MODULE_4__directive__["b" /* nextShow */]);
...
var addCategory = new Vue({
    ...
    data: {
        ...
        db: __WEBPACK_IMPORTED_MODULE_0__db1__["a" /* default */]
    },
    ...
    methods: {
        newSkill: function newSkill(e) {
            ...
            // })
            Object(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* child */])(e.target, 'button.primary').disabled = 'disabled';
            this.uploading = 1;
            this.uploadRes = 'Saving <img src="./dist/images/loading.gif" alt="">';
            setTimeout(function () {
                _this.uploading = 2;
                _this.uploadRes = '<span class="success feedback">Saved..</span>';
                Object(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* child */])(e.target, 'button.primary').disabled = '';
                setTimeout(function () {
        ...
        createFocus: function createFocus(e) {
            Object(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* child */])(e.target, 'input').focus();
        },
        datepick: function datepick(el, event) {
            var date = __WEBPACK_IMPORTED_MODULE_3_js_datepicker___default()(event.target, {
