...
var vm = new Vue({
    ...
    methods: {
        pushTab(newTab, e) {
            const parentSiblings = e.target.parentElement.parentElement.children,
                parent = e.target.parentElement;
            [...parentSiblings].forEach(ele => {
                if (ele == parent)
        ...
        toggleAccordion(e){
            ...
            if (c.contains('fa-chevron-circle-down'))c.replace('fa-chevron-circle-down','fa-chevron-circle-up')
            else c.replace('fa-chevron-circle-up', 'fa-chevron-circle-down')
